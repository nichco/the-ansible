...
if __name__ == "__main__":
    aero_client = ExplicitClient(channel=grpc.insecure_channel("localhost:50052"))
    struct_client = ExplicitClient(channel=grpc.insecure_channel("localhost:50051"))

    opt = AugmentedLagrangianBlockCoordinateDescent(clients=[aero_client, struct_client], 
                                                    x_init=x_init, 
                                                    con=con,
                                                    mu=1,
                                                    max_mu=1e3,
