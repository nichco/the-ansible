...
class Quartic1(pmdo.ExplicitDiscipline):
    """
    ...
    def compute(self, inputs, outputs):
        ...
        print('outputs: ', np.array([ans[0], ans[1], x1_2, x2_2]))
        outputs["x"] = np.array([ans[0], ans[1], x1_2, x2_2])
...
if __name__ == "__main__":
    ...
    discipline = pmdo.ExplicitServer(discipline=Quartic1())
    discipline.attach_to_server(server)

    # server.add_insecure_port("[::]:50052") # localhost only
